...
public class BitmapHelper {
    ...
    static
    {
    	...
    	segmentColors.put("agricultura_e_pecuaria", "#fa5c00");
    	segmentColors.put("agronegocio", "#01C93E");
    	segmentColors.put("alimentacao", "#FF0000");
    	segmentColors.put("criador_de_ovinos", "#96a7bd");
    	segmentColors.put("criador_gir_leiteiro", "#6493F2");
    	segmentColors.put("criador_girolando", "#2cd16b");
    	segmentColors.put("criador_guzera", "#662D91");
    	segmentColors.put("criador_nelore", "#F16633");
    	segmentColors.put("criador_santa_rosalia", "#f2b906");
    	segmentColors.put("vendas", "#0061A1");
    	
    	//TODO completar a lista de segmentos da expoagro
    }
