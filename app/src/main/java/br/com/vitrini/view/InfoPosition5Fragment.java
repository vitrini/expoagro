...
public class InfoPosition5Fragment extends Fragment 
{
	...
	private void setContent( View view )
	{
		...
		String content = StringUtils.htmlFileFromAssetsToString("main_screen_content/lingueta_restaurantes.html", view.getContext());
