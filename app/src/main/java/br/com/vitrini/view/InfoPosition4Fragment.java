...
public class InfoPosition4Fragment extends Fragment 
{
	...
	private void setContent( View view )
	{
		...
		String content = StringUtils.htmlFileFromAssetsToString("main_screen_content/lingueta_hoteis.html", view.getContext());
